<?php
    ...
    if(isset($_SESSION['id_user'])){
       ...
       if($type == 3){
            $information="SELECT o.ID_op AS id_operation, o.ID_user AS id_user, o.ID_account AS id_account, o.ID_cripto AS id_cripto, o.ID_wallet_cripto AS id_wallet_cripto, o.ID_bank AS id_bank,o.type AS type, o.cripto_amount AS cripto_amount, o.pesos_amount AS pesos_amount, o.date_hour AS date_hour, o.state AS state, 
            ...
            o.date_hour between '$date_from' and '$date_to' and
            o.ID_cripto = $cripto";
       }
