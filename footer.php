        ...
        <div class="row justify-content-around">
            ...
            <div class="col-4">
                <div class="redes mb-2">
                    ...
                    <div class="circle-footer float-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16" style="margin: 7px 8px;">
                    ...
                    <div class="circle-footer float-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16" style="margin: 7px;">
                    ...
                    <div class="circle-footer float-circle">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16" style="margin: 7.2px;">
                ...
                <br>
                <div>
                    <span class="title"><b>TERMINOS Y CONDICIONES/LEGALES</b></span>
                    <p class="text-footer">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                </div>
