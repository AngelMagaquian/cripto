                ...
                if(dato.second_last_name == ""){
                    ...
                    var last_name = dato.last_name + ' ' + dato.second_last_name;
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="" class="btn btn-danger mr-2 mt-sm-0 mt-3" type="button" data-toggle="modal" data-target="#modaDatosBancarios" id="modal_show_button">
                            ...
                            <td class="text-center">
                                <a href="" class="btn btn-warning mr-2 mt-sm-0 mt-3" type="button" data-toggle="modal" data-target="#modalCripto" id="modal_show_button">
                            ...
                            <td class="text-center">
                                <a href="" class="btn btn-secondary mr-2 mt-sm-0 mt-3" type="button" data-toggle="modal" data-target="#modalDeposito" id="modal_show_button">
